    ...
    public class SearchLeaves{
        public void SearchByTitle(int id, string path)
        {
            try{
                    ...
                    string title="";
                    //string path=@"C:\Users\mrudulap\projects\Leaves.csv";
                    ...
                    Console.WriteLine("Not able to search by Title....Something goes wrong...");
                }
        }
        ...
        public void SearchByStatus(int id, string path)
        {
            try{
                ...
                Console.WriteLine("Not able to search by status...Somthing goes wrong....");
            }
